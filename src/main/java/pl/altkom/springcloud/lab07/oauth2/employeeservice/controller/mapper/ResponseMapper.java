...
public class ResponseMapper {
    public static List<Employee> map(
            final List<pl.altkom.springcloud.lab07.oauth2.employeeservice.repository.model.Employee> employees) {
        return employees.stream()
                .map(ResponseMapper::map)
                .collect(Collectors.toList());
    }

    public static Employee map(final pl.altkom.springcloud.lab07.oauth2.employeeservice.repository.model.Employee employee) {
